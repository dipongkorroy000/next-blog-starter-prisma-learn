...
const getAllUser = async () => {
  const result = await prisma.user.findMany({
    select: { id: true, name: true, email: true, phone: true, picture: true, createdAt: true, updatedAt: true, role: true, status: true, posts: true },
...
export const UserService = { createUser, getAllUser, getUserById, updateUser, deleteUser };
